...
2. 在「基於版本設定」標題下，為「版本開」選擇圓。

   ![版本.png](images/version-on.png)

3. 選擇日曆表徵圖並指定所需的日期和時間。
...
4. 選中「使用基線」(Use Baseline)複選框，然後從下拉清單中選擇要使用的基線。
...
4. 對於要修改的主題，請從「版本」列下的下拉清單中選擇所需的版本。
...
2. 選擇 **建立**。
   ...
   將顯示一個名為「新輸出」的新輸出預設頁。
3. 在「設定名稱」欄位中，輸入用戶友好名稱。

4. 選中「使用基線」(Use Baseline)複選框，然後從下拉菜單中選擇所需的基線。
