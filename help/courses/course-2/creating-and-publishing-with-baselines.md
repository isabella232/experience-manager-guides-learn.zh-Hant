...
2. 在「根據設定版本」標題下，選取「版本於」的社交圈。

   ![version-on.png](images/version-on.png)

3. 選取日曆圖示並指定您想要的日期和時間。
...
4. 選取「使用基線」核取方塊，然後從下拉式清單中選取您要使用的基線。
...
4. 對於您要修改的主題，從「版本」欄下的下拉式清單中選取所需的版本。
...
3. 在「設定名稱」欄位中，輸入好記的名稱。

4. 選取「使用基線」核取方塊，然後從下拉式功能表中選取所需的基線。
