...
2. 按一下 [!UICONTROL **切換標籤視圖**] 表徵圖以隱藏標籤。
...
2. 在「用戶首選項」對話框中，按一下 [!UICONTROL **主題**] 下拉清單。
...
2. 在「用戶首選項」對話框中，按一下 [!UICONTROL **資料夾配置檔案**] 下拉清單。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **常規**] 頁籤。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **面板**] 頁籤。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **元素清單**] 頁籤。

3. 鍵入 **元素名稱** 和 **標籤** 的上界。

4. 按一下 [!UICONTROL **加**] 表徵圖可向清單中添加更多元素。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **屬性清單**] 頁籤。

3. 鍵入 **屬性名稱** 和 **標籤** 的上界。

4. 按一下 [!UICONTROL **加**] 表徵圖可向清單添加更多屬性。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **條件**] 頁籤。
...
2. 在「編輯器設定」對話框中，按一下 [!UICONTROL **配置檔案**] 頁籤。

3. 按一下 [!UICONTROL **加**] 表徵圖。
