...
1. 在管理員使用者下方，從下拉式清單中選取使用者或輸入使用者名稱。
...
1. 按一下 [!UICONTROL **儲存**] 在新增所有使用者時顯示於畫面的右上角。
...
1. 在左側面板上，選取任何非必要預設集的核取方塊。

   ![刪除預設集](images/lesson-3/delete-presets.png)

1. 按一下 [!UICONTROL **刪除預設集**] 在畫面左上角。
...
1. 在「XML編輯器代碼段」下，按一下 [!UICONTROL **上傳**].
