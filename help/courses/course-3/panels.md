...
1. 按一下 [!UICONTROL **省略號**] 位於主題旁邊，可訪問上下文選項。

1. 選擇 **添加到** > **收藏夾**。

1. 在「添加到收藏夾」對話框中，選擇 **新建集合** 或 **現有集合**。

   在此，我們將選擇添加到現有集合。

   ![收藏夾對話框](images/lesson-5/add-to-favorites-dialog.png)

1. 如果需要，請從下拉清單中選擇一個集合。
...
1. 在「收藏夾」(Favorites)下，按一下 [!UICONTROL **箭頭**] 表徵圖，查看其內容。

   ![查看收藏夾](images/lesson-5/view-favorites.png)

1. 按一下 [!UICONTROL **省略號**] 選項，包括從「收藏夾」清單中刪除該選項。
...
1. 如果需要，按一下搜索類別旁邊的箭頭表徵圖以進一步縮小搜索範圍。
...
1. 在結果菜單中，選擇「建立」 [!UICONTROL **代碼段**]。

   ![建立代碼片段](images/lesson-5/create-snippet.png)

1. 在「新建代碼段」對話框中，添加 **標題** 和 **說明**。
...
1. 設定 **文檔狀態** 至 **編輯**。 請注意，「參照」(References)清單當前為空。

   ![無引用](images/lesson-5/no-references.png)

1. 關閉主題。

1. 選擇 [!UICONTROL **儲存庫視圖**] 的下界。
...
1. 開啟地圖進行編輯後，切換回 **儲存庫視圖**。

1. 將正在處理的主題拖放到映射中。

1. 按一下 [!UICONTROL **保存**] 表徵圖
...
1. 按一下 [!UICONTROL **建立審閱**]。

   ![建立審閱](images/lesson-5/create-review.png)

1. 在「建立審閱任務」對話框中，根據需要填充欄位。
