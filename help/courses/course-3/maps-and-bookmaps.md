...
1. 在「Blueprint」(Blueprint)頁面上，選擇要使用的映射模板類型，然後按一下 [!UICONTROL **下一個**].

1. 在「屬性」頁面上，輸入 **標題** 和 **名稱** 地圖。
...
1. 從「存放庫檢視」將內容拖放至對映或書籤中的有效位置。

或

1. 按一下地圖或書籤地圖內的有效位置。

1. 按一下適當的 [!UICONTROL **工具欄表徵圖**] 添加章節、主題或topicref。
...
1. 按一下 [!UICONTROL **左箭頭**] 將topicref提升至章節，或 [!UICONTROL **向右鍵**] 將章節降級為主題。
...
1. 使用標準鍵盤快速鍵，將需要的元素從地圖複製並貼到可重複使用中。

## 將屬性指派給地圖中的topicref

1. 在地圖中反白顯示topicref或巢狀topicref集合。

1. 在「內容屬性」面板的「其他屬性」下，選擇 **屬性** 和 **值。**
