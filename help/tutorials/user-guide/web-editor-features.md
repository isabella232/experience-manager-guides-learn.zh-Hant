...
AEM Guides提供的功能可顯示專案中的所有稽核任務。 您可在審閱專案中檢視您所屬的所有審閱專案和作用中審閱任務。 **檢閱** 面板。  然後，您可以開啟稽核任務以檢視各種稽核者的評論。
稽核面板會顯示稽核任務。 身為作者，您可以使用網頁編輯器處理主題中的註解。


若要檢視專案中現有之使用中複查作業的複查註解，請執行下列步驟：

1. 選取檢閱 ![](images/active-review-tasklist-icon.svg)   在左側面板。 此 **檢閱** 面板隨即開啟。  系統會顯示您所屬之審閱專案中的所有審閱專案及作用中審閱任務。

   ![](images/web-editor-review-panel.png){width="300" align="left"}
1. 選取稽核專案，然後從清單中選取稽核任務以開啟它。
1. 您也可以透過下列方式篩選專案：

   - 在專案標題中輸入您要尋找的搜尋字詞或文字。 然後按下Enter以執行搜尋。 例如，您可以搜尋標題中包含「space」字詞的所有專案。

   - 選取 ![](images/filter-search-icon.svg)  以開啟 **篩選** 對話方塊。 您可以選取所有專案或僅選取特定專案。 所選專案會列在 **檢閱** 面板。
     ![](images/active-review-select-project.png){width="300" align="left"}

     此 **由我起始的任務** 選項預設為啟用。 它可讓您僅檢視您已起始的任務。

1. 依預設，在您的稽核專案中，您將檢視含有相關註解的主題平面清單。 從左側邊欄套用所需的篩選器，以根據主題中呈現的稽核評論來篩選主題：

   - **檢視所有主題**：列出專案中存在的所有主題。
   - **檢視含有註解的主題**：僅列出包含稽核評論的主題。
1. 您也可以輸入要在主題標題或檔案路徑中尋找的搜尋字詞或文字。 會列出標題或檔案路徑中包含該辭彙的主題。
1. 連按兩下任何主題，以在作者檢視中開啟。 您可在以下位置檢視註釋： **註解** 面板。
   ...
   > 如需如何處理註解的詳細資訊，請檢視 [地址稽核評論](review-address-review-comments.md#).
